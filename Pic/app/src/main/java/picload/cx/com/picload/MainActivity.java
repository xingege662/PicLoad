package picload.cx.com.picload;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //配置
        ImageLoaderCofig.Builder build = new ImageLoaderCofig.Builder();
        build.setThreadCount(3) //线程数量
                ...
                .setFailedImage(R.drawable.not_found);

        ImageLoaderCofig config = build.build();
        //初始化
